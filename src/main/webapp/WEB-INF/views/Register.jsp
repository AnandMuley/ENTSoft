<form class="form-signin">
      ...
      <div class="row">
          <div class="col-sm-6">
              ...
              <input type="text" id="inputForename" class="form-control" placeholder="First Name" required="" autofocus="">
          </div>
          <div class="col-sm-6">
      ...
      <div class="row">
          ...
          <div class="col-sm-6">
              ...
              <input type="phone" id="inputContactNo" class="form-control" placeholder="ContactNo" required="">
          </div>
      </div>
      <br/>

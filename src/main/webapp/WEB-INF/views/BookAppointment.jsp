			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="row">
						...
						<div class="col-md-6 appointment-text-label">Time Slot</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<input required="required" type="date" class="form-control input-group-lg" name="datedOn" placeholder="For Date"/>
						</div>
						<div class="col-md-6">
							<input required="required" class="form-control input-group-lg" name="timeSlot"/>
						</div>
					</div>
				</div>
			</div>
